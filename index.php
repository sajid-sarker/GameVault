...
<head>
    ...
    <style>
        .bg-image {
            background-image: url("./images/cyberpunk-cover.jpg");
...
<body>
    ...
    <section id="product" class="bg-image">
      <div class="position-relative overflow-hidden p-3 p-md-5 m-md-0 text-center bg-body-primary ">
        
        <div class="col-md-6 p-lg-5 mx-auto my-5">
            
          <h1 class="display-2 fw-bold text-light">GAME VAULT</h1>
          <h3 class="fw-normal mb-3 text-light">Your one stop shop for video games</h3>
        </div>
      </div>
    </section> 

    <h2 class="fw-normal my-3 display-5 text-center">Latest Arrivals</h2>
          ...
          <div class="carousel-item">
            ...
            <div class="container">
              <div class="carousel-caption text-start">
                ...
                <p><a class="btn btn-lg btn-primary" href="./products.php">Browse collection</a></p>
              </div>
            </div>
          </div>
          <div class="carousel-item active">
            ...
            <div class="container">
              <div class="carousel-caption">
                ...
                <p><a class="btn btn-lg btn-primary" href="./products.php">See other games</a></p>
              </div>
            </div>
          </div>
          <div class="carousel-item">
            ...
            <div class="container">
              <div class="carousel-caption text-end">
                ...
                <p><a class="btn btn-lg btn-primary" href="./products.php">Learn more</a></p>
              </div>
            </div>
          </div>
        </div>
